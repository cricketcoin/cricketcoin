...
uint256 hashGenesisBlock("0x6dea08522612c27e648211e6d67573995eead26047df1a4ebc7192c167cafa58");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // CricketCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "CricketCoin Signed Message:\n";
...
{
    // CricketCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // CricketCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // CricketCoin: 3.5 days
static const int64 nTargetSpacing = 150; // CricketCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // CricketCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // CricketCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // CricketCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfe71059db090a34d4e664dc8ef698aa52eda36ba8c7d5dc6f95afe9d9c8c018c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("59da1cc0efaffd305888cff7f9d56cf4d6eb9a37e0aaf7d27d3ee2bcd7b41858d2c02bdd1b3cbe84e1855b6e0437c9e36ff50bf8646b41b2d71ce998ef9821961a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1514605155;
        block.nBits    = 504365644;
        block.nNonce   = 1604487503;

        if (fTestNet)
        {
            block.nTime    = 1514605155;
            block.nNonce   = 1491104979;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2d9ae13193bbb982f5b9b47220459aa2bac7999505699fb98e61df2b26a7b2a3"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // CricketCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CricketCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CricketCoinMiner : ProcessBlock, block not accepted");
    }
